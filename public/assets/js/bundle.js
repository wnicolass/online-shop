...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "h1 {\n  text-align: center;\n  color: var(--color-gray-300);\n}\n\nform {\n  background-color: var(--primary-color-500-contrast);\n  text-align: center;\n\n  max-width: 25rem;\n  margin: var(--space-8) auto;\n\n  border-radius: var(--border-radius-small);\n}\n\nform a {\n  position: relative;\n  color: var(--primary-color-200);\n  transition: color 0.3s ease;\n}\n\nform a:hover {\n  color: var(--primary-color-500);\n}\n\nform a::after {\n  content: '';\n  background-color: var(--primary-color-500);\n\n  height: 2px;\n  width: 0%;\n\n  position: absolute;\n  bottom: 0;\n  left: 0;\n\n  transition: width 0.3s ease;\n}\n\nform a:hover::after {\n  width: 100%;\n}\n", "",{"version":3,"sources":["webpack://./frontend/assets/styles/auth.css"],"names":[],"mappings":"AAAA;EACE,kBAAkB;EAClB,4BAA4B;AAC9B;;AAEA;EACE,mDAAmD;EACnD,kBAAkB;;EAElB,gBAAgB;EAChB,2BAA2B;;EAE3B,yCAAyC;AAC3C;;AAEA;EACE,kBAAkB;EAClB,+BAA+B;EAC/B,2BAA2B;AAC7B;;AAEA;EACE,+BAA+B;AACjC;;AAEA;EACE,WAAW;EACX,0CAA0C;;EAE1C,WAAW;EACX,SAAS;;EAET,kBAAkB;EAClB,SAAS;EACT,OAAO;;EAEP,2BAA2B;AAC7B;;AAEA;EACE,WAAW;AACb","sourcesContent":["h1 {\n  text-align: center;\n  color: var(--color-gray-300);\n}\n\nform {\n  background-color: var(--primary-color-500-contrast);\n  text-align: center;\n\n  max-width: 25rem;\n  margin: var(--space-8) auto;\n\n  border-radius: var(--border-radius-small);\n}\n\nform a {\n  position: relative;\n  color: var(--primary-color-200);\n  transition: color 0.3s ease;\n}\n\nform a:hover {\n  color: var(--primary-color-500);\n}\n\nform a::after {\n  content: '';\n  background-color: var(--primary-color-500);\n\n  height: 2px;\n  width: 0%;\n\n  position: absolute;\n  bottom: 0;\n  left: 0;\n\n  transition: width 0.3s ease;\n}\n\nform a:hover::after {\n  width: 100%;\n}\n"],"sourceRoot":""}]);
// Exports
